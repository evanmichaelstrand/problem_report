...
url = "https://" + domain + "/e/" + tenantID + "/api/v2/problems?from=now-" + timeframe + "d"
    ...
    #loop through all of the pages to make sure we grab all of the data
        if problemCount > 50:
            while data['nextPageKey']:
                ...
                newURL = "https://" + domain + "/e/" + tenantID + "/api/v2/problems?nextPageKey=" + nextPageKey
